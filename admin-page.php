...
if ( ! current_user_can('manage_options') )
	...
	if ( isset($_POST['srel_saveopt']) ) {
		...
		$new_opt['menucolor'] = preg_match("/[0-9A-Fa-f]{6}/", $_POST['menucolor']) ? strtolower($_POST['menucolor']) : '000000';
...
value="<?php echo js_escape(__("Show Help", "srel-l10n")); ?>" /></p>
	...
	<h4><?php _e('You can add Shutter Reloaded Plus to your site in five different ways:', 'srel-l10n'); ?> </h4>
...
?>
	...
	<label for="showfblike"><?php _e('Show Facebook Like Button?', 'srel-l10n'); ?></label>
